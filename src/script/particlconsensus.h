...
#ifndef BITCOINC_SCRIPT_BITCOINCCONSENSUS_H
#define BITCOINC_SCRIPT_BITCOINCCONSENSUS_H
...
#include <config/bitcoin-config.h>
  ...
  #endif
#elif defined(MSC_VER) && !defined(STATIC_LIBBITCOINCCONSENSUS)
...
#endif // BITCOINC_SCRIPT_BITCOINCCONSENSUS_H
