...
{
    return QCoreApplication::translate("bitcoinc-core", psz).toStdString();
}
...
{
    SplashScreen *splash = new SplashScreen(m_node, Qt::CustomizeWindowHint | Qt::FramelessWindowHint, networkStyle);
...
{
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. Bitcoin Confidential can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(EXIT_FAILURE);
}
