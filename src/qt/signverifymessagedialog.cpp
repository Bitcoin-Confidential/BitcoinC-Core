    ...
    platformStyle(_platformStyle)
{
    ...
    ui->addressBookButton_SM->setIcon(platformStyle->BitcoinCColorIcon(":/icons/address-book"));
    ui->pasteButton_SM->setIcon(platformStyle->BitcoinCColorIcon(":/icons/editpaste"));
    ui->copySignatureButton_SM->setIcon(platformStyle->BitcoinCColorIcon(":/icons/editcopy"));
    ui->signMessageButton_SM->setIcon(platformStyle->SingleColorIcon(":/icons/edit"));
    ui->clearButton_SM->setIcon(platformStyle->BitcoinCColorIcon(":/icons/remove"));
    ui->addressBookButton_VM->setIcon(platformStyle->BitcoinCColorIcon(":/icons/address-book"));
    ui->verifyMessageButton_VM->setIcon(platformStyle->SingleColorIcon(":/icons/transaction_0"));
    ui->clearButton_VM->setIcon(platformStyle->BitcoinCColorIcon(":/icons/remove"));
...
void SignVerifyMessageDialog::on_btnSignMessage_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);
    ui->btnSignMessage->setChecked(true);
    ui->btnVerifyMessage->setChecked(false);
}

void SignVerifyMessageDialog::on_btnVerifyMessage_clicked()
{
    ui->stackedWidget->setCurrentIndex(1);
    ui->btnSignMessage->setChecked(false);
    ui->btnVerifyMessage->setChecked(true);
}
