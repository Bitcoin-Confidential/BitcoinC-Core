...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "listunspentstaking", 0, "minconf" },
    { "listunspentstaking", 1, "maxconf" },
    { "listunspentstaking", 2, "addresses" },
    { "listunspentstaking", 3, "include_unsafe" },
    { "listunspentstaking", 4, "query_options" },
