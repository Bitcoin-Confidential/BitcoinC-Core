...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x00000000000000000000000000000000000000000000010f9972de95e3fb34db");
...
*/
        ...
        base58Prefixes[PUBKEY_ADDRESS_256] = {0x99}; // 6 ColdStake
