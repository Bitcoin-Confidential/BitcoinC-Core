// Copyright (c) 2018 The Bitcoin Confidential Core developers
// Distributed under the MIT/X11 software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BITCOINC_USBDEVICE_USBDEVICE_H
#define BITCOINC_USBDEVICE_USBDEVICE_H
...
public:
    ...
    bool IsBitcoinCVersion() const override { return txTo && txTo->IsBitcoinCVersion(); }
...
#endif // BITCOINC_USBDEVICE_USBDEVICE_H
